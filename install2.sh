...
git clone https://github.com/tpope/vim-dispatch.git ~/.janus/vim-dispatch
...
git clone https://github.com/mattn/calendar-vim.git ~/.janus/calendar-vim
#mysnippets
git clone https://github.com/majutsushi/tagbar.git ~/.janus/tagbar
git clone https://github.com/vim-scripts/taglist.vim.git ~/.janus/taglist-vim
git clone https://github.com/jacoborus/tender.vim.git ~/.janus/tender-vim
git clone https://github.com/tyrannicaltoucan/vim-quantum.git ~/.janus/tyrannicaltoucan-vim-quantum
git clone https://github.com/inkarkat/vim-SyntaxRange.git ~/.janus/vim-SyntaxRange
git clone https://github.com/jceb/vim-orgmode.git ~/.janus/vim-orgmode
git clone https://github.com/prettier/vim-prettier.git ~/.janus/vim-prettier
git clone https://github.com/tpope/vim-speeddating.git ~/.janus/vim-speeddating
